...
## 6. Задача №3. Методы машинного и глубокого обучения
...
### Дополнительный анализ аномалий временного ряда

Дополнительно для оценки необычных наблюдений во временном ряду были применены три метода выявления аномалий:
...
### Визуализация ML/DL-моделей и дополнительного анализа аномалий
